...
function toDirectionPage() {
	...
	if(curPosition==null){
		...
		//		url=encodeURI("http://maps.google.com/maps?f=d&source=s_d&saddr="+"current+location"+"&daddr="+store.latitude+","+store.longitude+"&hl=us&t=m&dirflg=d");
	}
	//log("url==="+url);
...
function doSignInLevelUp_base(userName,password){
	...
	access_token.api_key = levelup_api_key;//api_key or client_id ???
