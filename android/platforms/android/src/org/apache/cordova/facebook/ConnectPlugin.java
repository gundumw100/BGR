...
public class ConnectPlugin extends CordovaPlugin {
	...
	public void initialize(CordovaInterface cordova, CordovaWebView webView) {
		...
		Log.i("tag", "AccessToken=="+session.getAccessToken());
	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
		...
		if (action.equals("login")) {
			...
			for (int i = 0; i < args.length(); i++) {
				...
				Log.i("tag", "Permissions=="+arrayPermissions[i]);
			}
...
//			for (int i = 0; i < args.length(); i++) {
//				Log.d("tag","isPermissionGranted="+session.isPermissionGranted(args.getString(i)) );
//			}
			...
			if(session!=null&& session.isOpened()){
				...
				callbackContext.error("No valid session found, did you installed the Facebook app ?");
//				execute("login", args, callbackContext);//debug
			}
			return true;
...
//				Log.i("tag", "name:"+params.getString("name"));
//				Log.i("tag", "description:"+params.getString("description"));
//				Log.i("tag", "link:"+params.getString("link"));
//				Log.i("tag", "caption:"+params.getString("caption"));
//				Log.i("tag", "message:"+params.getString("message"));
				Log.i("tag", "name:"+paramBundle.getString("name"));
				Log.i("tag", "description:"+paramBundle.getString("description"));
				Log.i("tag", "link:"+paramBundle.getString("link"));
				Log.i("tag", "caption:"+paramBundle.getString("caption"));
				Log.i("tag", "message:"+paramBundle.getString("message"));
...
//		        postParams.putString("name", params.getString("name"));
//		        postParams.putString("description", params.getString("description"));
//		        postParams.putString("link", params.getString("link"));
//		        postParams.putString("caption", params.getString("caption"));
//		        postParams.putString("message", params.getString("message"));
////				p.putString("picture", "picture_url");
//
...
//		                if (error != null) {
//		                	 Log.i("tag","ErrorMessage==="+response.getError().getErrorMessage());
//		                	Toast.makeText(cordova.getActivity(),  error.getErrorMessage(), Toast.LENGTH_SHORT).show();//postId
//		                } else {
//		                	Log.i("tag","RawResponse==="+response.getRawResponse());
//		                    Toast.makeText(cordova.getActivity(),  "Your message is shared with your friends.", Toast.LENGTH_SHORT).show();//postId
//		                }
//		            }
//		        };
